...
//  var template = Handlebars.compile($('.author-stats').text());//#stats
  ...
  var template  = app.Article.numWordsByAuthor().forEach(stat => $('.author-stats').append(template(stat)));
    Handlebars.compile(template).text();//#stats
